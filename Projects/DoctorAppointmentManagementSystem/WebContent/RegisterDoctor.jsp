...
<script type="text/javascript">
    ...
    function register()
    {
        ...
        headers['email'] = email;
        headers['specialization'] = specialization;
        httpGetAsync("http://localhost:8080/DoctorAppointmentManagementSystem/RestServices/register/doctor", success, headers);
...
<div class="login-page">
  <div class="form">
    <div>
      ...
      <p class="message">Already registered? <a href="http://localhost:8080/DoctorAppointmentManagementSystem/LoginDoctor">Sign In</a></p>
    </div>
  </div>
</div>