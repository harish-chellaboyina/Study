...
<script type="text/javascript">
	function navigateToCreateAppointment(){
		...
		window.location.href='http://localhost:8080/DoctorAppointmentManagementSystem/createNewAppointment?patientId=' + patientId;
	}
...
<div class="list-page">
  <div class="form">
        <center><button onclick="navigateToCreateAppointment()">New Appointment</button></center><br>
        <c:forEach items="${appointments}" var="appointment">
          <div class='item'>
                ...
                <div class='date'>
                    ...
                    <img src="Images/delete1.png" class="trilokImg" onclick="deleteAppointment(${appointment.appointmentId})"></img>
